...
ADD ./main.go /go/src/github.com/admkc/rtsp-stream/main.go
ADD ./core /go/src/github.com/admkc/rtsp-stream/core
ADD ./Gopkg.toml /go/src/github.com/admkc/rtsp-stream/Gopkg.toml
WORKDIR /go/src/github.com/admkc/rtsp-stream
